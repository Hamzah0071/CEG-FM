...
<div class="div1">
    ...
    <ul class="menu">
        ...
        <?php if($role === 'admin'): ?>
            ...
            <li class="submenu-item">
                <a href="#" class="menu-item">
                    ...
                    <img src="<?= $basePath ?>images/icone/fleche-bas.png" alt="flèche" class="arrow-icon">
                </a>
                <ul class="submenu">
                    <li>
                    ...
                    <li>
                        ...
                        <img src="<?= $basePath ?>images/icone/inscription.png" alt=""> Inscription / Réinscription
                        </a>
                    </li>
                    <li>
                        <a href="<?= $basePath ?>admin/transfert-eleve.php" class="menu-item">
                        <img src="<?= $basePath ?>images/icone/transfert.png" alt=""> Transfert / Radiation
                        </a>
                    </li>
                    <li>
                        <a href="<?= $basePath ?>admin/certificat-scolarite.php" class="menu-item">
                        <img src="<?= $basePath ?>images/icone/certificat.png" alt=""> Certificats & attestations
                        </a>
                    </li>
                </ul>
            </li>
        ...
        <?php else: ?>
            ...
            <li><a href="<?= $basePath ?>actualites/" class="menu-item">
                <img src="<?= $basePath ?>images/icone/actualites.png" alt=""> <span>Actualités</span>
            </a></li>
        <?php endif; ?>
    </ul>
</div>
