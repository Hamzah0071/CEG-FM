...
<body>
        ...
        <div class="content-section">
            <div class="table">
                ...
                <div class="add-form" id="addForm">
                    ...
                    <input type="text" id="classInput" placeholder="Classe">
                    <input type="text" id="dateInput" placeholder="Date de naissance (DD/MM//YYYY)">
    ...
    <!-- <script src="../scripts/liste/AJ-matier.js" type="module"></script> -->
</body>
</html>